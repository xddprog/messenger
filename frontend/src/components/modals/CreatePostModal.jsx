import {Button, Form, Input, message, Modal, Popover, Typography, Upload} from "antd";
...
export default function CreatePostModal({isOpen, handleIsOpen, addPostAfterCreate}) {
            ...
            >
                ...
                <Form form={form[0]} name={'zxc'} onFinish={submitCreatePost}>
                    ...
                    >
                        ...
                        >
                            <Button icon={<UploadOutlined />} >Upload (Максимум 4 фото)</Button>
                        </Upload>
                    </Form.Item>
                </Form>
            </Modal>
